...
a. GT Ultra SID emulation has been modified to allow per-channel stereo

panning. This can be used to bring new life to SID music, as well as being
useful for SID remixes and such like.
b. As an example of what stereo panning can offer, here’s a set of classic Rob

Hubbard music, processed in TrueStereo
https://soundcloud.com/noothermedicine/reconstructed-rob-hubbard-in-truest
ereo
c. To enable TrueStereo, set the panning type to “Pan”

![image](../images/manual/page-08-img-1.png)

d. Within each instrument, there is a “Pan” setting, which is comprised of two

pan values

![image](../images/manual/page-08-img-2.png)
...
e. Every time an instrument is played (a key ON is performed), a random pan

value is set, somewhere between (and including) the two pan values.
...
a. When playing in either mono or stereo mode (not True Stereo) it is possible to

set the panning position of each SID chip.
