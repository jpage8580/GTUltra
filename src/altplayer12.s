...
mt_loadregswave:
				cpx #63
				bcs mt_loadregswave_sid4
				cpx #42
				bcs mt_loadregswave_sid3
                cpx #21
...
mt_loadregswave_sid3:
              ...
              .IF (SOUNDSUPPORT != 0)
                lda mt_chnsfx,x
                bne mt_loadskipadsr_sid3
              .ENDIF
                lda mt_chnad,x
                sta SID3BASE-42+$05,x
                lda mt_chnsr,x
                sta SID3BASE-42+$06,x
mt_loadskipadsr_sid3:
                rts

;==
mt_loadregswave_sid4:
                lda mt_chnwave,x
                and mt_chngate,x
              ...
              .IF (SOUNDSUPPORT != 0)
                lda mt_chnsfx,x
                bne mt_loadskipadsr_sid4
              .ENDIF
                lda mt_chnad,x
                sta SID4BASE-63+$05,x
                lda mt_chnsr,x
                sta SID4BASE-63+$06,x
mt_loadskipadsr_sid4:
                rts
...
mt_sfxexec_sid3:
                ...
                sta SID3BASE-42+$05,x                ;Hardrestart before sound FX
                sta SID3BASE-42+$06,x                ;begins
                jmp mt_loadregswave_sid3
...
mt_sfxexec_sid4:
                ...
                sta SID4BASE-63+$05,x                ;Hardrestart before sound FX
                sta SID4BASE-63+$06,x                ;begins
                jmp mt_loadregswave_sid4
